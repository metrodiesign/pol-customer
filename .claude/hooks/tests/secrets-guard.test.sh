...
# prefix split so the file never holds a contiguous sk_live_ literal — GitHub push
# protection flags it as a real Stripe key. Runtime value is unchanged.
run_case block "Stripe live key"         staged src/pay.txt 'stripe = sk_'"live"'_4eC39HqLyjWDarjtT1zdp7dcABCDEFGH'
