...
| Frontend Admin (Next.js 16) | `pol-admin` | 5400 |
...
Frontend ขึ้นที่ `http://localhost:5400`
...
```bash
npm run dev      # รัน dev server (:5400)
...
| Service | Port | URL |
|---------|------|-----|
| pol-admin (Next.js) | 5400 | http://localhost:5400 |
...
Browser (5400)
  ...
  v
Next.js Dev Server (5400) -- rewrite /producer/* -->
  |
  v
